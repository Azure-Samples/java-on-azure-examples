...
| Name | Link | Status
| ---- | ---- | ------
| 1. [Create an Azure Storage Account](storage/create/README.md) | [Workflow](.github/workflows/storage_create_README_md.yml) | [![storage/storage/create/README.md](https://github.com/Azure-Samples/java-on-azure-examples/actions/workflows/storage_create_README_md.yml/badge.svg)](https://github.com/Azure-Samples/java-on-azure-examples/actions/workflows/storage_create_README_md.yml)
