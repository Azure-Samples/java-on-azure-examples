...
| 4. | [Push a Glassfish Docker image to Azure Container Registry](acr/glassfish/) | [Workflow](.github/acr_glassfish_README_md.yml) | ![acr/glassfish/README.md](https://github.com/Azure-Samples/java-on-azure-examples/workflows/acr/glassfish/README.md/badge.svg)
